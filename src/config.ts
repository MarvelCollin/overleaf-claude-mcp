...
export const CACHE_DIR = process.env.OVERLEAF_CACHE_DIR ?? path.join(HOME_DIR, "cache");

export const CACHE_TTL_MS = Number(process.env.OVERLEAF_CACHE_TTL_MS ?? 60_000);
